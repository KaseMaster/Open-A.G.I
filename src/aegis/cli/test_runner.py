#!/usr/bin/env python3
"""
AEGIS CLI Test Runner Module
Test execution interface for AEGIS Framework
"""
...
try:
    ...
    print(f"⚠️  Advertencia: No se pudieron importar módulos de test: {e}")
    print("Asegúrate de que test_framework y test_suites estén disponibles en el path")
...
class AEGISTestRunner:
    ...
    def __init__(self):
        try:
            ...
            print("❌ Error: test_framework no está disponible")
            sys.exit(1)
...
def main():
    """Entry point for aegis-test command"""
    try:
